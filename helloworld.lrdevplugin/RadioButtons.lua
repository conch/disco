...
--[[
	Demonstrates a custom dialog with a complex binding. The dialog display two
	radio buttons and a label.  The contents of the label is updated depending on 
	...
	from the transform function is a string or our choosing, rather than the value of the 
		...
		local c = f:column {
			...
			f:row{
				f:column {
					...
					-- Radio buttons are selected when its value is equal to its checked_value.
